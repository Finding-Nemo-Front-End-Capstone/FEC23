...
function ChacBreak({rating}) {
  ...
  useEffect(() => {
    const chacFunc = (input) => {
      const value = rating.characteristics[input].value;
  ...
  return (
    <div className='chacBreak'>
      <div className='chac' style={{display:comfortDis}}>
        ...
        <div class="bar-containerCB">
        <div class="bar-container1" ></div>
        <span className="arrow-comfort" style={{'margin-left':comfort}}>&#8679;</span>
        </div>
      </div>
      ...
      <text>Quality:</text>
        ...
        <div class="bar-containerCB">
        <div class="bar-container1" ></div>
        <span className="arrow-quality" style={{'margin-left':quality}}>&#8679;</span>
        </div>
      </div>
      ...
      <text>Size:</text>
        ...
        <span className="arrow-quality" style={{'margin-left':size}}>&#8679;</span>
        </div>
      </div>
      ...
      <text>Width:</text>
        ...
        <div class="bar-containerCB">
        <div class="bar-container2" ></div>
        <span className="arrow-quality" style={{'margin-left':width}}>&#8679;</span>
        </div>
      </div>
      ...
      <text>Length:</text>
        ...
        <div className='comfyDesc'>
          ...
          <div class="bar-containerCB">
          <div class="bar-container2" ></div>
          <span className="arrow-quality" style={{'margin-left':length}}>&#8679;</span>
          </div>
        </div>
      ...
      <text>Fit:</text>
        ...
        <div className='comfyDesc'>
          ...
          <div class="bar-containerCB">
          <div class="bar-container2" ></div>
          <span className="arrow-quality" style={{'margin-left':fit}}>&#8679;</span>
          </div>
        </div>
    </div>
  )
